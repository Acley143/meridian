...
/**
 * {@code GET /portfolios/{id}/audit}. services/core-service/PLAN.md scoped this to a Q1 501 stub
 * pending the Q2 audit-log deliverable -- but ADR-0008's hash chain landed in Session 05b, ahead of
 * that schedule, and trade booking now writes a real {@code trade_booked} entry (see
