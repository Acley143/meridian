 ...
 * {@code POST /api/v1/trades} goes through {@code PortfolioMutationService}, which publishes to
 * {@code portfolio.state} and needs a live broker to construct its producer at all.
 */
